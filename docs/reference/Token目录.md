...
| `--fds-g-color-amber-dark-11` | `color` | `#FFB992` | `#FFB992` | `tokens/atomic/map/color/dark/amber.yml` |
| `--fds-g-color-amber-dark-2` | `color` | `#442B1E` | `#442B1E` | `tokens/atomic/map/color/dark/amber.yml` |
| `--fds-g-color-amber-dark-3` | `color` | `#593622` | `#593622` | `tokens/atomic/map/color/dark/amber.yml` |
| `--fds-g-color-amber-dark-4` | `color` | `#744124` | `#744124` | `tokens/atomic/map/color/dark/amber.yml` |
| `--fds-g-color-amber-dark-5` | `color` | `#924D23` | `#924D23` | `tokens/atomic/map/color/dark/amber.yml` |
| `--fds-g-color-amber-dark-6` | `color` | `#B2591C` | `#B2591C` | `tokens/atomic/map/color/dark/amber.yml` |
| `--fds-g-color-amber-dark-7` | `color` | `#D76813` | `#D76813` | `tokens/atomic/map/color/dark/amber.yml` |
...
| `--fds-g-color-blue-dark-11` | `color` | `#8FC8FF` | `#8FC8FF` | `tokens/atomic/map/color/dark/blue.yml` |
| `--fds-g-color-blue-dark-2` | `color` | `#1E3143` | `#1E3143` | `tokens/atomic/map/color/dark/blue.yml` |
| `--fds-g-color-blue-dark-3` | `color` | `#223E58` | `#223E58` | `tokens/atomic/map/color/dark/blue.yml` |
| `--fds-g-color-blue-dark-4` | `color` | `#244D73` | `#244D73` | `tokens/atomic/map/color/dark/blue.yml` |
| `--fds-g-color-blue-dark-5` | `color` | `#235E91` | `#235E91` | `tokens/atomic/map/color/dark/blue.yml` |
| `--fds-g-color-blue-dark-6` | `color` | `#1C6FB2` | `#1C6FB2` | `tokens/atomic/map/color/dark/blue.yml` |
...
| `--fds-g-color-green-dark-11` | `color` | `#98E0AF` | `#98E0AF` | `tokens/atomic/map/color/dark/green.yml` |
| `--fds-g-color-green-dark-2` | `color` | `#223829` | `#223829` | `tokens/atomic/map/color/dark/green.yml` |
| `--fds-g-color-green-dark-3` | `color` | `#284934` | `#284934` | `tokens/atomic/map/color/dark/green.yml` |
| `--fds-g-color-green-dark-4` | `color` | `#2C5D3E` | `#2C5D3E` | `tokens/atomic/map/color/dark/green.yml` |
| `--fds-g-color-green-dark-5` | `color` | `#2D7449` | `#2D7449` | `tokens/atomic/map/color/dark/green.yml` |
| `--fds-g-color-green-dark-6` | `color` | `#2A8B54` | `#2A8B54` | `tokens/atomic/map/color/dark/green.yml` |
...
| `--fds-g-color-indigo-dark-11` | `color` | `#80AFFF` | `#80AFFF` | `tokens/atomic/map/color/dark/indigo.yml` |
| `--fds-g-color-indigo-dark-2` | `color` | `#192843` | `#192843` | `tokens/atomic/map/color/dark/indigo.yml` |
| `--fds-g-color-indigo-dark-3` | `color` | `#1B3258` | `#1B3258` | `tokens/atomic/map/color/dark/indigo.yml` |
| `--fds-g-color-indigo-dark-4` | `color` | `#1B3B73` | `#1B3B73` | `tokens/atomic/map/color/dark/indigo.yml` |
| `--fds-g-color-indigo-dark-5` | `color` | `#194692` | `#194692` | `tokens/atomic/map/color/dark/indigo.yml` |
| `--fds-g-color-indigo-dark-6` | `color` | `#1350B4` | `#1350B4` | `tokens/atomic/map/color/dark/indigo.yml` |
...
| `--fds-g-color-magenta-dark-11` | `color` | `#FFA4A9` | `#FFA4A9` | `tokens/atomic/map/color/dark/magenta.yml` |
| `--fds-g-color-magenta-dark-2` | `color` | `#442426` | `#442426` | `tokens/atomic/map/color/dark/magenta.yml` |
| `--fds-g-color-magenta-dark-3` | `color` | `#5A2B2E` | `#5A2B2E` | `tokens/atomic/map/color/dark/magenta.yml` |
| `--fds-g-color-magenta-dark-4` | `color` | `#743137` | `#743137` | `tokens/atomic/map/color/dark/magenta.yml` |
| `--fds-g-color-magenta-dark-5` | `color` | `#933641` | `#933641` | `tokens/atomic/map/color/dark/magenta.yml` |
| `--fds-g-color-magenta-dark-6` | `color` | `#B33949` | `#B33949` | `tokens/atomic/map/color/dark/magenta.yml` |
...
| `--fds-g-color-purple-dark-11` | `color` | `#A897F1` | `#A897F1` | `tokens/atomic/map/color/dark/purple.yml` |
| `--fds-g-color-purple-dark-2` | `color` | `#26213D` | `#26213D` | `tokens/atomic/map/color/dark/purple.yml` |
| `--fds-g-color-purple-dark-3` | `color` | `#2F264F` | `#2F264F` | `tokens/atomic/map/color/dark/purple.yml` |
| `--fds-g-color-purple-dark-4` | `color` | `#3A2C66` | `#3A2C66` | `tokens/atomic/map/color/dark/purple.yml` |
| `--fds-g-color-purple-dark-5` | `color` | `#463081` | `#463081` | `tokens/atomic/map/color/dark/purple.yml` |
| `--fds-g-color-purple-dark-6` | `color` | `#53349E` | `#53349E` | `tokens/atomic/map/color/dark/purple.yml` |
...
| `--fds-g-color-red-dark-11` | `color` | `#FFA793` | `#FFA793` | `tokens/atomic/map/color/dark/red.yml` |
| `--fds-g-color-red-dark-2` | `color` | `#44251E` | `#44251E` | `tokens/atomic/map/color/dark/red.yml` |
| `--fds-g-color-red-dark-3` | `color` | `#5A2D22` | `#5A2D22` | `tokens/atomic/map/color/dark/red.yml` |
| `--fds-g-color-red-dark-4` | `color` | `#743325` | `#743325` | `tokens/atomic/map/color/dark/red.yml` |
| `--fds-g-color-red-dark-5` | `color` | `#933A26` | `#933A26` | `tokens/atomic/map/color/dark/red.yml` |
| `--fds-g-color-red-dark-6` | `color` | `#B33E24` | `#B33E24` | `tokens/atomic/map/color/dark/red.yml` |
| `--fds-g-color-red-dark-7` | `color` | `#D84422` | `#D84422` | `tokens/atomic/map/color/dark/red.yml` |
| `--fds-g-color-red-dark-8` | `color` | `#FF522A` | `#FF522A` | `tokens/atomic/map/color/dark/red.yml` |
| `--fds-g-color-red-dark-9` | `color` | `#FF7252` | `#FF7252` | `tokens/atomic/map/color/dark/red.yml` |
| `--fds-g-color-special-1` | `color` | `#F2F4FB` | `#F2F4FB` | `tokens/atomic/map/color/special.yml` |
...
| `--fds-g-color-teal-dark-11` | `color` | `#91D4CE` | `#91D4CE` | `tokens/atomic/map/color/dark/teal.yml` |
| `--fds-g-color-teal-dark-2` | `color` | `#203533` | `#203533` | `tokens/atomic/map/color/dark/teal.yml` |
| `--fds-g-color-teal-dark-3` | `color` | `#244441` | `#244441` | `tokens/atomic/map/color/dark/teal.yml` |
| `--fds-g-color-teal-dark-4` | `color` | `#265552` | `#265552` | `tokens/atomic/map/color/dark/teal.yml` |
| `--fds-g-color-teal-dark-5` | `color` | `#256A65` | `#256A65` | `tokens/atomic/map/color/dark/teal.yml` |
| `--fds-g-color-teal-dark-6` | `color` | `#1E7F78` | `#1E7F78` | `tokens/atomic/map/color/dark/teal.yml` |
| `--fds-g-color-teal-dark-7` | `color` | `#129890` | `#129890` | `tokens/atomic/map/color/dark/teal.yml` |
...
| `--fds-g-color-yellow-dark-11` | `color` | `#FFD794` | `#FFD794` | `tokens/atomic/map/color/dark/yellow.yml` |
| `--fds-g-color-yellow-dark-2` | `color` | `#433620` | `#433620` | `tokens/atomic/map/color/dark/yellow.yml` |
| `--fds-g-color-yellow-dark-3` | `color` | `#594625` | `#594625` | `tokens/atomic/map/color/dark/yellow.yml` |
| `--fds-g-color-yellow-dark-4` | `color` | `#735727` | `#735727` | `tokens/atomic/map/color/dark/yellow.yml` |
| `--fds-g-color-yellow-dark-5` | `color` | `#916B24` | `#916B24` | `tokens/atomic/map/color/dark/yellow.yml` |
| `--fds-g-color-yellow-dark-6` | `color` | `#B17F17` | `#B17F17` | `tokens/atomic/map/color/dark/yellow.yml` |
...
| `--fds-g-color-yellow-green-dark-11` | `color` | `#B9E398` | `#B9E398` | `tokens/atomic/map/color/dark/yellow-green.yml` |
| `--fds-g-color-yellow-green-dark-2` | `color` | `#2D3A22` | `#2D3A22` | `tokens/atomic/map/color/dark/yellow-green.yml` |
| `--fds-g-color-yellow-green-dark-3` | `color` | `#384B28` | `#384B28` | `tokens/atomic/map/color/dark/yellow-green.yml` |
| `--fds-g-color-yellow-green-dark-4` | `color` | `#455F2D` | `#455F2D` | `tokens/atomic/map/color/dark/yellow-green.yml` |
| `--fds-g-color-yellow-green-dark-5` | `color` | `#52762F` | `#52762F` | `tokens/atomic/map/color/dark/yellow-green.yml` |
| `--fds-g-color-yellow-green-dark-6` | `color` | `#5F8F2E` | `#5F8F2E` | `tokens/atomic/map/color/dark/yellow-green.yml` |
| `--fds-g-color-yellow-green-dark-7` | `color` | `#70AB2F` | `#70AB2F` | `tokens/atomic/map/color/dark/yellow-green.yml` |
| `--fds-g-color-yellow-green-dark-8` | `color` | `#87CC3B` | `#87CC3B` | `tokens/atomic/map/color/dark/yellow-green.yml` |
| `--fds-g-color-yellow-green-dark-9` | `color` | `#94D455` | `#94D455` | `tokens/atomic/map/color/dark/yellow-green.yml` |
## Atomic / Map / effects
